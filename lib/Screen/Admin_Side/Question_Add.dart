...
class _QuestionAddState extends State<QuestionAdd> {
  ...
  bool isLoading = false; // Loading state for Send button
  ...
  double uploadProgress = 0; // Upload progress for image
  void addOption() {
                                        ...
                                        onPressed: isLoading
                                            ...
                                            : () async {
                                                ...
                                                if (organization.isEmpty ||
                                                    city.isEmpty) {
                                                  _showSnackBar(
                                                      "Admin organization and city information is missing",
                                                      Colors.red);
                                                  return;
                                                }
  ...
  Future<void> _fetchAdminInfo() async {
    final adminData = await _authService.getCurrentAdmin();
    if (mounted) {
      // Check if the widget is still in the widget tree
      if (adminData != null) {
        setState(() {
          organization = adminData.org;
          city = adminData.city;
        });
      } else {
        _showSnackBar("Failed to fetch admin information", Colors.red);
      }
    }
  }
  ...
  Future<String> _uploadImage(
      File imageFile, String organization, String city) async {
    final storageRef = FirebaseStorage.instance.ref();
    final imageRef = storageRef.child(
        'questions/$organization/$city/${questionTitleController.text}_${DateTime.now().millisecondsSinceEpoch}.jpg');
  ...
  //   final storageRef = FirebaseStorage.instance.ref();
  //   final imageRef = storageRef.child(
  //       'questions/${questionTitleController.text}_${DateTime.now().millisecondsSinceEpoch}.jpg');
