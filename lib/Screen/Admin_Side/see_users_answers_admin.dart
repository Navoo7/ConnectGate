...
//   final Map<String, double> optionPercentageMap = {};
...
//       if (!model.isonline)
//         return Nointernet(); // Ensure this widget is defined or replace with an appropriate widget
...
//                   optionPercentageMap:
//                       optionPercentageMap, // Pass the percentage map to the card
//                 ),
//               ),
//             ],
//           ),
...
//   void calculateOptionPercentages(List<List<dynamic>> answersList) {
//     final totalAnswers = answersList.length;
//     if (totalAnswers == 0) return;

//     final Map<String, int> optionCountMap = {};

//     for (var answer in answersList) {
//       final option = answer[2]; // Assuming option is in the 3rd column
//       if (optionCountMap.containsKey(option)) {
//         optionCountMap[option] = optionCountMap[option]! + 1;
//       } else {
//         optionCountMap[option] = 1;
//       }
//     }

//     optionCountMap.forEach((option, count) {
//       optionPercentageMap[option] = (count / totalAnswers) * 100;
//     });
//   }
...
//       calculateOptionPercentages(answersList);
