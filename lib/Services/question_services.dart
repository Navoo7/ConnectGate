...
class QuestionService {
  ...
  Future<void> addQuestionToFirestore({
    ...
    String? imageFile, // Add the image file parameter
  }) async {
    try {
      ...
      await questionRef.set({
        ...
        'groupIds': groupIds,
        'groupname': groupname,
        'imageUrl': imageFile, // Add the image URL to Firestore
        'createdAt': FieldValue.serverTimestamp(),
        'org': adminData.org,
        'city': adminData.city,
      });
      _showSnackBar('Question sent successfully!', Colors.green, context);
    } catch (e) {
      _showSnackBar('Error saving question: $e', Colors.red, context);
    }
  }
  ...
  //   final ref = _storage
  //       .ref()
  //       .child('questions/${DateTime.now().millisecondsSinceEpoch}.jpg');
